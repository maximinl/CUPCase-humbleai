#!/bin/bash
# v10-n100: 9B bf16 + thinking ON + 27B bf16 judge — N=100
# Purpose: Cheapest good config? 9B+CoT vs 27B no-think
#SBATCH --job-name=hf-v10n
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:h200:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=256G
#SBATCH --time=18:00:00
#SBATCH --output=slurm-hf/logs/v10-n100-%j.out
#SBATCH --error=slurm-hf/logs/v10-n100-%j.err
...
python3.11 hf_experiment.py \
    ...
    --samples 100 --seed 42 \
    --max-tokens 2048 \
    --output-dir output-hf/v10-n100-9bthink-27bjudge
