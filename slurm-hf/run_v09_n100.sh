#!/bin/bash
# v09-n100: 27B bf16 main + 9B bf16 small + 27B bf16 judge — N=100
# Purpose: True ensemble (different model sizes) at scale
#SBATCH --job-name=hf-v09n
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:h200:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=256G
#SBATCH --time=03:00:00
#SBATCH --output=slurm-hf/logs/v09-n100-%j.out
#SBATCH --error=slurm-hf/logs/v09-n100-%j.err
...
python3.11 hf_experiment.py \
    ...
    --samples 100 --seed 42 \
    --max-tokens 1024 \
    --output-dir output-hf/v09-n100-27bmain-9bsmall-27bjudge
