#!/bin/bash
# v07-n100: 27B bf16 generation + 27B bf16 judge — N=100
# Purpose: Best quality baseline at scale
#SBATCH --job-name=hf-v07n
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:h200:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=256G
#SBATCH --time=03:00:00
#SBATCH --output=slurm-hf/logs/v07-n100-%j.out
#SBATCH --error=slurm-hf/logs/v07-n100-%j.err
...
python3.11 hf_experiment.py \
    ...
    --samples 100 --seed 42 \
    --max-tokens 1024 \
    --output-dir output-hf/v07-n100-27bbf16-27bjudge
